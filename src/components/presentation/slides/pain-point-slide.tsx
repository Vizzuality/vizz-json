    ...
    <div className="slide items-start">
      ...
      <CodeBlock>
        <code>
          ...
          <span className="token-string">"interpolate"</span>, [
          <span className="token-string">"linear"</span>], [
          ...
          {step < 1 && <span className="token-string">"#ffffff"</span>}
          {'\n'}
          {'  }'}
          {'\n'}
          {'}'}
      ...
      <Step visible={step >= 1} className="mt-6">
        <p className="text-sm text-destructive">
          Magic numbers everywhere. Change the scale? Touch every value. Change
          the color? Find every string.
        </p>
      </Step>
    </div>
  )
