  ...
  return (
    <div className="slide items-start">
      ...
      <p className="mb-10 text-muted-foreground">
        Declare a class or React component by name. The converter instantiates it with the
        surrounding properties as props.
      </p>
      ...
      <Step visible={step >= 1} className="mt-8 w-full">
        <div className="flex items-center gap-6">
          ...
          <div className="rounded-lg border border-border bg-card px-6 py-4">
            <p className="mb-2 text-sm font-semibold text-chart-3">{'<BasicLegend />'}</p>
            <div className="flex items-center gap-3">
              <div className="h-4 w-4 rounded" style={{ background: '#22c55e' }} />
