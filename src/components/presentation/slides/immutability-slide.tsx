      ...
      <CodeBlock>
        <code>
          <span className="token-comment">
            // resolveParams builds a NEW object
          </span>
          {'\n'}
          <span className="token-key">const</span> result = {'{}  '}
          <span className="token-comment">// fresh object</span>
          {'\n'}
          <span className="token-key">for</span> (
          <span className="token-key">const</span> [key, value]{' '}
          <span className="token-key">of</span> Object.entries(obj)) {'{\n'}
          {'  '}result[key] = resolveValue(value, params){'\n'}
          {'}\n'}
          <span className="token-key">return</span> result{' '}
          <span className="token-comment">// original untouched</span>
        </code>
      </CodeBlock>
