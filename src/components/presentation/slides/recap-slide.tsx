...
const TAKEAWAYS = [
  {
    title: 'JSON as a config language',
    desc: 'Declarative map configurations without imperative code',
  },
  {
    title: 'The @@ prefix convention',
    desc: 'Five prefixes covering params, functions, types, expressions, and constants',
  },
  {
    title: 'Two-stage resolution pipeline',
    desc: 'Params first, then deck.gl converter — clean separation of concerns',
  },
  {
    title: 'Immutable by design',
    desc: 'Original config never mutated — safe to re-resolve with different params',
  },
] as const
